...
$(function() {
  ...
  $("button").click(/* function for when the button is clicked goes here */getQuestionAndAnswer);
  /*
...
function fetchRandomTriviaQuestion(callback) {
  ...
  var promise = $.get("https://opentdb.com/api.php?amount=1&category=27&type=boolean&encode=base64"); //https://opentdb.com/api.php?amount=10&category=21&difficulty=medium&type=boolean
